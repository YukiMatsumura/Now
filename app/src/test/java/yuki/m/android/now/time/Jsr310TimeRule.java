 ...
 */
public class Jsr310TimeRule implements TestRule {
    ...
    private void unlockCurrentTime() {
        if (!Jsr310TimeRule.locked) {
            throw new IllegalMonitorStateException("Clock is unlocked.");
        }
        Jsr310Time.tickCurrentTime();
        Jsr310TimeRule.locked = false;
    }
